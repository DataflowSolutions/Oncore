...
import { syncScheduleItemToAdvancing } from "@/lib/actions/sync-schedule-to-advancing";
...
interface ScheduleItem {
  ...
  endTime?: string;
  notes?: string;
  itemType?: string | null; // The actual item_type from database (hotel, catering, etc)
  autoGenerated?: boolean; // Whether this is auto-generated from advancing
}
...
export function CalendarDayView({
  ...
  return (
    <div className="h-[calc(100vh-13rem)] flex flex-col">
      ...
      <div className="w-full max-w-[1600px] mx-auto flex-1 min-h-0">
            ...
            <ScheduleTimeline
              ...
              onUpdateItem={async (
                ...
                if (
                  ...
                  // Map arrival to departure type for the sync function (both are flight types)
                  const syncType =
                    itemType === "arrival" ? "departure" : itemType;
                  await syncScheduleItemToAdvancing(
                    orgSlug,
                    showId,
                    itemId,
                    syncType as "hotel" | "catering" | "departure",
                    starts_at,
                    ends_at
                  );
                }
