...
export function RolesPermissionsTab({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
            {(["owner", "admin", "editor", "viewer"] as OrgRole[]).map(
              (role) => {
      ...
      <AlertDialog
        open={!!removingUserId}
        onOpenChange={(open: boolean) => !open && setRemovingUserId(null)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              all access to this organization. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
