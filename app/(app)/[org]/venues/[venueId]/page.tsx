...
import { MapPin, Globe, Calendar, Users, Building, ArrowLeft, Phone } from 'lucide-react'
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="mt-2 text-foreground/50">
              {venue.city && venue.country ? `${venue.city}, ${venue.country}` : venue.city || venue.country || 'Venue details'}
            </p>
          </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {venue.city && venue.country ? `${venue.city}, ${venue.country}` : venue.city || venue.country || 'Not specified'}
                    </p>
                  </div>
                </div>
                ...
                {venue.capacity && (
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{venue.capacity.toLocaleString()} people</p>
                    </div>
                  </div>
                )}

                <div className="text-xs text-muted-foreground pt-4 border-t">
                  Added on {new Date(venue.created_at).toLocaleDateString('en-US', {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric'
                  })}
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-sm text-muted-foreground">
                    ...
                    <p className="mt-1">Use this for production contacts, technical coordinators, and venue management</p>
                  </div>
                </CardContent>
              </Card>
            )}
                      ...
                      >
                        <div className="flex justify-between items-start gap-2">
                          <div className="flex-1 min-w-0">
                            <h4 className="font-medium truncate">{show.title || 'Untitled Show'}</h4>
                          ...
                          <Badge variant={show.status === 'confirmed' ? 'default' : 'secondary'} className="text-xs">
                            {show.status}
                          </Badge>
                        </div>
                      </Link>
            ...
            {shows.length === 0 && (
              <Card>
                <CardContent className="text-center py-8">
                  ...
                  <p className="text-muted-foreground">No shows at this venue yet</p>
